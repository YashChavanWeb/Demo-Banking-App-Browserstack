...
const s = StyleSheet.create({
  ...
  addBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: BSColors.orange, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10 },
  ...
  avatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: BSColors.orange, alignItems: 'center', justifyContent: 'center', marginRight: 10 },
