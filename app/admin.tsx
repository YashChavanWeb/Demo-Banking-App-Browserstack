...
const s = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fff', paddingHorizontal: 20, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: '#EEF2FF' },
  ...
  addBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: BSColors.primary, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 11 },
  ...
  avatar: { width: 42, height: 42, borderRadius: 21, backgroundColor: BSColors.primary, alignItems: 'center', justifyContent: 'center', marginRight: 10 },
